...
- [커밋 메시지 규칙 하네스](DEV-2026-005-commit-message-policy-harness.md) — 한국어 개조식 제목·필수 본문·문단 간격 규칙을 Git commit-msg 훅으로 자동 검사한다.
...
- [Treasure Hunters 플레이 데모](DEV-2026-009-treasure-hunters-playable-demo.md) — 스크린샷 로컬 보관 정책에 이어 PPU 32 임포트 기반을 반영하고 조립 에셋·표현 로직·씬을 분리 커밋 중이다.
